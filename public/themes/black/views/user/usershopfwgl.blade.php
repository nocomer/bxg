    ...
    <div class="clearfix g-reletaskhd hidden-xs">
        <form action="/user/acceptTasksList" method="get">
            <div class="pull-left">
                ...
                <a class="g-usershopfbtn bg-blue hov-blue1b" href=""><i class="fa fa-plus text-size12"></i>&nbsp;&nbsp;发布服务</a>
            </div>
        </form>
        <div class="pull-right">
            <div class="text-size14 g-usershopli g-releasechart visible-lg-block hidden-xs hidden-sm hidden-md" href="javascript:;">
                <i class="usershoplico"></i>
                <div class="g-releasehidea"></div>
                <div class="g-releasehide">
                    <div class="g-usershopdetail">
                        <div class="g-usershopdehd">交易明细</div>
                        <p>上架服务：  <span class="cor-orange">0</span></p>
                        <p>完成服务：  <span class="cor-orange">0.00元</span></p>
                        <p>累计收入：  <span class="cor-orange">0</span></p>
                        <div class="g-usershopdebtn clearfix">可用提现：<span class="cor-orange">5000.00</span>
                            <a class="btn-big bg-gary bor-radius2 hov-bggryb0" href="">提现</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <li class="row width590">
                ...
                <div class="col-sm-11 col-xs-10 usernopd">
                    <div class="col-sm-9 col-xs-8">
                        <div class="text-size14 cor-gray51"><span class="cor-orange">￥1111</span>&nbsp;&nbsp;<a class="cor-blue42" href="">服务名称</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;上架</div>
                        <div class="space-6"></div>
                        <p class="cor-gray87"><i class="fa fa-eye cor-grayd2"></i> 16人浏览/4人购买&nbsp;&nbsp;&nbsp;<i class="fa fa-clock-o cor-grayd2"></i> 2017-06-02</p>
                        <div class="space-6"></div>
                    ...
                    <div class="col-sm-3 col-xs-4 text-right hiden590">
                        ...
                        <p class="g-usershopshow"><a class="g-usershopsmbtn" href="">编辑</a><a class="g-usershopsmbtn" href="">下架</a></p>
                    </div>
