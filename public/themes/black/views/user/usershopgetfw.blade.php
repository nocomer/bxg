<div class="g-main g-releasetask">
    ...
    <ul id="useraccept">
            <li class="row width590">
                ...
                <div class="col-sm-11 col-xs-10 usernopd">
                    <div class="col-sm-9 col-xs-8">
                        <div class="text-size14 cor-gray51"><span class="cor-orange">￥1111</span>&nbsp;&nbsp;<a class="cor-blue42" href="">名称</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;待付款</div>
                        <div class="space-6"></div>
        ...
        <li class="row width590">
            ...
            <div class="col-sm-11 col-xs-10 usernopd">
                <div class="col-sm-9 col-xs-8">
                    <div class="text-size14 cor-gray51"><span class="cor-orange">￥1111</span>&nbsp;&nbsp;<a class="cor-blue42" href="">名称</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;交易成功</div>
                    <div class="space-6"></div>
                    <p class="cor-gray87"><i class="fa fa-user cor-grayd2"></i> 水馒头&nbsp;&nbsp;&nbsp;<i class="fa fa-clock-o cor-grayd2"></i> 2017-06-02</p>
                    <div class="space-6"></div>
                    <p class="cor-gray51 p-space">想找一个熟悉microship芯片12F系列的朋友，在读懂程序功能的基础上，写出功能流程说明和注</p>
        ...
        <li class="row width590">
            ...
            <div class="col-sm-11 col-xs-10 usernopd">
                <div class="col-sm-9 col-xs-8">
                    <div class="text-size14 cor-gray51"><span class="cor-orange">￥1111</span>&nbsp;&nbsp;<a class="cor-blue42" href="">名称</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;工作中</div>
                    <div class="space-6"></div>
                    <p class="cor-gray87"><i class="fa fa-user cor-grayd2"></i> 水馒头&nbsp;&nbsp;&nbsp;<i class="fa fa-clock-o cor-grayd2"></i> 2017-06-02</p>
                    <div class="space-6"></div>
                    <p class="cor-gray51 p-space">想找一个熟悉microship芯片12F系列的朋友，在读懂程序功能的基础上，写出功能流程说明和注</p>
        ...
        <li class="row width590">
            ...
            <div class="col-sm-11 col-xs-10 usernopd">
                <div class="col-sm-9 col-xs-8">
                    <div class="text-size14 cor-gray51"><span class="cor-orange">￥1111</span>&nbsp;&nbsp;<a class="cor-blue42" href="">名称</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;验收中</div>
                    <div class="space-6"></div>
                    <p class="cor-gray87"><i class="fa fa-user cor-grayd2"></i> 水馒头&nbsp;&nbsp;&nbsp;<i class="fa fa-clock-o cor-grayd2"></i> 2017-06-02</p>
                    <div class="space-6"></div>
                    <p class="cor-gray51 p-space">想找一个熟悉microship芯片12F系列的朋友，在读懂程序功能的基础上，写出功能流程说明和注</p>
