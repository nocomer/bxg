    ...
    <div class="sign-main">
        <div class="sign-main-content">
            ...
            <div class="sign-main-container register-main-container phone-main-container email-main-container">
                ...
                <div class="space"></div>
                <div class="clearfix">
                    <form class="login-form registerform form-horizontal " method="post" action="{!! url('password/reset') !!}">
                        {!! csrf_field() !!}
                        ...
                        <div class="userPassword user-position-relative">
                            ...
                            <span class="block input-icon input-icon-right login-error_wrong Validform-wrong-red Validform-wrong-red-height">
                                <input type="password" class="inputbd form-control inputxt bor-radius2" placeholder="" name="password" nullmsg="请输入您的新密码" datatype="*6-18" errormsg="请输入6-18个字符，支持英文、数字" autocomplete="off" disableautocomplete>
                        ...
                        <div class="userPassword user-position-relative">
                            ...
                            <span class="block input-icon input-icon-right login-error_wrong Validform-wrong-red Validform-wrong-red-height">
                                <input type="password" name="confirmPassword" class="inputbd form-control inputxt bor-radius2" placeholder="" name="password" nullmsg="请确认新密码" datatype="*6-16" errormsg="两次密码不一致" autocomplete="off" disableautocomplete>
