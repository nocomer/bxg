            ...
            <form action="/task/createTask" method="post" id="form" enctype="multipart/form-data">
                ...
                <div class="row">
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            {{ (!empty(old('xuanshang')))?'in':'' }} @if($task['type_id'] == $type_v['id'])in active @endif" id="ck">
                                                    <div class="mission-ck z-check-validform-ck">
                                                        ...
                                                        <div>
                                                            <input type="text" name="worker_num{{$type_v['alias']}}" class="mis-txt" datatype="positive"  nullmsg="请填写服务商数量！" errormsg="请填写大于0的整数！" @if($task['type_id'] == $type_v['id'])value="{{$task['worker_num']}}" @endif>>
                                                        ...
                                                        <input name="delivery_deadline{{$type_v['alias']}}" type="hidden"
                                                               ...
                                                               v@if($task['type_id'] == $type_v['id']) value="{!! ($task['delivery_deadline'])?date('Y年m月d日',strtotime($task['delivery_deadline'])):date('Y年m月d日',time()) !!}" @endif />
                    ...
                    <div class="task-bt">
                        ...
                        <button class="btn btn-primary btn-blue bor-radius2 btn-big1 preservation" onclick="sluSub(1)">保存</button>
                        <a href="javascript:sluSub(2);"  class="text-size14 preview">预览任务</a>
                        <a href="javascript:sluSub(3);" class="text-size14 not_released">暂不发布</a>
                    </div>
                </div>
            </form>
        </div>
