    ...
    <div class="row">
        <div class="col-lg-9 list-l col-md-12 col-left">
                                ...
                                <ul class="mg-margin list-inline task-list-label">
                                    ...
                                    @if($detail['region_limit'])
                                        <li class="cor-gray51 clearfix p-space">
                                            ...
                                            地区：@if(isset($area[$detail['province']]['name']) && isset($area[$detail['city']]['name']) && isset($area[$detail['area']]['name']))
                    ...
                    <div id="home" class="tab-pane fade  bg-white active in">
                        ...
                        <div class="task-description cor-gray51">
                            <div class="description-main">
                                ...
                                <p style="text-align:right;margin-right:20px;"><span class="js_more" style="cursor:pointer;"><span class="text">查看更多</span> <i class="fa fa-angle-double-down"></i></span></p>
                            </div>
                            <div class="description-main task-taskdisplay">
                                <div>
                                    <p class="h4 description-title"><b>任务附件<span class="text-muted">({{ count($attatchment) }})</span></b></p>
                                    <!-- <span class="hr"></span> -->
                                </div>
            ...
            <ul class="tasknav clearfix mg-margin nav nav-tabs">
                <li class="{{ ((!empty($_COOKIE['table_index']) && $_COOKIE['table_index']==1) || !isset($_COOKIE['table_index']))?'active ':'' }} in" index="1" onclick="rememberTable($(this))">
