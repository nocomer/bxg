                ...
                <div class=" col-md-12">
                    <div class="input-group search-bd col-md-9">
                        <div class="input-group-btn btn-wd">
                            <button type="button" class="btn  btn-color" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                任务<span class="fa fa-angle-down"></span>
                            </button>
                    ...
                    <div class="form-group">
                        <span class="wd">或者<button class="btn btn-danger btn-search btn-search-wd" type="button">发布任务</button></span>
                    </div>
                </div>
            </form>
