            ...
            @if(Auth::check())
                <div class="col-xs-12">
                    <div class="pull-left p-space">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;HI~ <a href="/user/index">{!! Auth::User()->name !!}</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="/user/messageList/1"><i class="fa fa-envelope-o"></i> 消息
                                @if(Theme::get('message_count') > 0)({!! Theme::get('message_count') !!})@endif
                            </a>&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="col-xs-12">
                <div class="pull-left hidden-xs">
                    <div class="">
                        ...
                        <span class="pull-left g-stationadd text-size18">
                ...
                <div class="col-xs-12 hidden-sm visible-xs-block">
                    <div class="text-center">
                        ...
                        <span class="g-stationadd text-size18">
                            {!! Theme::get('substationNAME') !!}站
                            <a class="cor-blue2f" data-toggle="modal" href="#address">[切换]</a>
                        </span>
                    </div>
                ...
                <div class="pull-right hidden-xs">
                    <div class="pull-right g-stationsarbtn hidden-sm">
                        <span>或</span><a class="bg-blue" href="{{ URL('task/create') }}">发布需求</a>
                    </div>
                    <div class="g-tasksearch g-stationsearch pull-right demo">
