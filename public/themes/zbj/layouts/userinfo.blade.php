...
<head>
    ...
    {{--<link rel="stylesheet" href="/themes/zbj/assets/css/ace/jquery.gritter.css">--}}
    ...
    <link rel="stylesheet" href="/themes/zbj/assets/css/usercenter/finance/finance-layout.css">
    <link rel="stylesheet" href="/themes/zbj/assets/css/usercenter/userslidebar.css">
    <link rel="stylesheet" href="/themes/zbj/assets/css/{!! Theme::get('color') !!}/style.css">
    <link rel="stylesheet" href="/themes/zbj/assets/css/{!! Theme::get('color') !!}/user.css">
...
@else
<script src="/themes/zbj/assets/js/doc/jquery.min.js"></script>
@endif
