...
<div class="g-main">
    ...
    <div class="text-center g-bankhint">
        <img src="{!! Theme::asset()->url('images/sign-icon1.png') !!}"><b>恭喜，您已经通过了实名认证！</b>
    ...
    <div class="space-10"></div>
    <div class="text-size14 cor-gray51 pdl54">真实姓名：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="inlineblock cor-gray97">{!! $realname !!} <span class="u-succeedicon">已认证</span></span></div>
    <div class="space-10"></div>
