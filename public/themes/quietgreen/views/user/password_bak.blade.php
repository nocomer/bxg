                                    ...
                                    <form class="passwordform form-horizontal" method="post" action="{!! url('password/email') !!}">
                                        ...
                                        <div class="form-group step-validform" >
                                            ...
                                            <div class="col-xs-12 col-lg-8 col-md-9 col-sm-10">
                                                <div class="clearfix block ">
                                                    <input class="forminput  inputxt col-sm-5 col-xs-12" type="text" name="email" id="email"  placeholder="请出入您的邮箱" datatype="e" ajaxurl="{!! url('password/checkEmail') !!}" nullmsg="请输入您的邮箱" errormsg="邮箱地址格式不对！">
                                        ...
                                        <div class="form-group step-validform">
                                            ...
                                            <div class="col-xs-12 col-sm-7">
                                                <div class="clearfix block">
                                                    <input class="col-xs-12 col-sm-3 inputxt forminput-code" type="text"  id="code" name="code"  placeholder="请输入验证码" datatype="s" ajaxurl="{!! url('password/checkCode') !!}" nullmsg="请输入验证码">
