...
{!! Theme::asset()->container('custom-js')->usepath()->add('sitelogo', 'js/sitelogo.js') !!}
{!! Theme::asset()->container('custom-css')->usepath()->add('croppers-css', 'css/cropper.css') !!}
{!! Theme::asset()->container('custom-js')->usepath()->add('sitelogo-css', 'css/sitelogo.css') !!}