        ...
        <form  class="registerform form-horizontal row" action="{{ URL('user/passwordUpdate') }}" method="post" role="form">
            ...
            <div class="form-group nomarb">
                ...
                <div class="col-sm-5 task-casebghid">
                    <span><input type="password" name="confirmPassword"  id="form-field-3" placeholder="确认新密码" class="col-xs-12 col-sm-12 inputxt valihide" recheck="password"  nullmsg="请再次输入密码" datatype="*6-18" errormsg="两次输入的密码不一致！"></span>
