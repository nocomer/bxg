        ...
        <div class="tabbable">
            ...
            <div class="tab-content clearfix f-tab">
                ...
                <div class="tab-pane in active clearfix text-size14 cor-gray51 u-pay" id="home1">
                    <form method="post" action="{{url('finance/balancePayment')}}">
                        {!! csrf_field() !!}
                        <input name="good_id" type="hidden" value="{!! $good_id !!}">
                    ...
                    <div class="text-center clearfix">
                        ...
                        <a href="/user/editGoods/{!! $good_id !!}" class="cor-gray93 btn-big">返回</a>
                    </div>
                    @else
                    <!--余额不足状态-->
                    <div class="text-size14 cor-gray51">
                        ...
                        <a href="/user/editGoods/{!! $good_id !!}" class="btn btn-white bor-radius2">返回</a>
                        <br>
                    </div>
                    @endif
                    </form>
                ...
                <div class="tab-pane clearfix" id="home2">
                    <form method="post" action="{{url('finance/thirdPayment')}}" target="_blank">
                    {!! csrf_field() !!}
                        <input name="good_id" type="hidden" value="{!! $good_id !!}">
                    <div class="space"></div>
                    <div class="radio clearfix">
                        ...
                        <label class="clearfix inline check-boxItm">
                            <input type="radio" name="pay_type" value='unionpay' class="ace"/>
                            <span class="lbl ">
                     ...
                     <div class="modal-body text-center clearfix">
                         ...
                         <div class="col-sm-8 hidden-xs">
                             <div class="cor-gray51 text-left">
                                 ...
                                 <div class="space"></div>
                                 <p>
                                     <a href="javascript:history.back()" type="button" class="btn btn-primary btn-sm btn-blue btn-big1 bor-radius2" >已完成付款</a>&nbsp;
                                     <a href="{!! CommonClass::contactClient(Theme::get('basis_config')['qq']) !!}" class="cor-blue167 text-under">支付遇到问题</a>
                                 </p>
                                 <p><a href="/finance/getpay/{!! $good_id !!}" class="cor-blue167 text-under">返回选择其他支付方式></a></p>
                             </div>
                         </div>
                         ...
                         <div class="hidden-lg hidden-md hidden-sm visible-xs-12">
                             <div class="cor-gray51 text-center">
                                 ...
                                 <p>
                                     <a href="javascript:history.back()" type="button" class="btn btn-primary btn-sm btn-blue btn-big1 bor-radius2" >已完成付款</a>&nbsp;
                                     <a href="{!! CommonClass::contactClient(Theme::get('basis_config')['qq']) !!}" class="cor-gray97 modaltxt">支付遇到问题</a>
                                 </p>
                                 <p><a href="/finance/getpay/{!! $good_id !!}" class="cor-blue167" data-dismiss="modal">返回选择其他支付方式></a></p>
                             </div>
                         </div>
                     </div>
