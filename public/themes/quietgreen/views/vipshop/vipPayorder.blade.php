                                ...
                                <div class="modal-body text-center clearfix">
                                    ...
                                    <div class="col-sm-8 hidden-xs">
                                        <div class="cor-gray51 text-left">
                                            ...
                                            <div class="space"></div>
                                            <p>
                                                <a href="/task/1489" type="button" class="btn btn-primary btn-sm btn-blue btn-big1 bor-radius2">已完成付款</a>&nbsp;
                                                <a href="/user/unreleasedTasks" class="cor-blue167 text-under">支付遇到问题</a>
                                            </p>
                                            <p><a href="/task/bounty/1489" class="cor-blue167 text-under">返回选择其他支付方式&gt;</a></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="hidden-lg hidden-md hidden-sm visible-xs-12">
                                        <div class="cor-gray51 text-center">
                                            ...
                                            <p><a href="/task/bounty/1489" class="cor-blue167" data-dismiss="modal">返回选择其他支付方式&gt;</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div><!-- /.modal-content -->
