...
@foreach($comment['data'] as $v)
    <div class="bidrecords">
        <div class="evaluate">
            <div class="record">
                <div class="row">
                    <div class="col-md-1 evaluateimg"><img src="{{ CommonClass::getDomain().'/'.CommonClass::getAvatar($v['from_uid']) }}" onerror="onerrorImage('{{ Theme::asset()->url('images/defauthead.png')}}',$(this))"></div>
