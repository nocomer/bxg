...
<div class="col-xs-12 col-left">
        <div class="taskDetails alert taskbg clearfix">
            ...
            <div class="cor-gray51 text-size14">
                <div class="space"></div>
                <p>支付金额：<span class="text-size26 cor-orange text-blod">￥{{ sprintf(" %1\$.2f",($task['bounty']+$service_money)) }}</span></p>
                <div class="space"></div>
                <p>请选择支付方式</p>
            </div>
            <div class="space"></div>
            <div class="tabbable">
                ...
                <div class="tab-content clearfix f-tab">
                    ...
                    <div class="tab-pane in active clearfix text-size14 cor-gray51 u-pay" id="home1">
                        @if($balance_pay)
                            <form class="form-horizontal" role="form" action="/task/bountyUpdate" method="post"  name="bounty-form">
                                {{ csrf_field() }}
                    ...
                    <div class="tab-pane clearfix" id="home2">
                        <form class="form-horizontal" role="form" action="/task/bountyUpdate" method="post"  name="bounty-form" target="_blank">
                            {{ csrf_field() }}
                            <input type="hidden" name="id" value="{{ $id }}" />
                                ...
                                <span class="lbl">
                                    <span  class="lbl-bank lbl-bank-weixinlogo">
                                        <div class="s-bank2 s-packbor">
                                            <img src="{!! Theme::asset()->url('images/trust-ico2.png') !!}../../../images/trust-ico2.png" alt="">
                                        </div>
                                    </span>
                                </span>
                            </label>
