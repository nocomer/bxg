        ...
        <div class="col-xs-12 col-left">
            <div class="taskDetails alert taskbg clearfix">
                ...
                <div class="cor-gray51 text-size14">
                    <div class="space"></div>
                    <p>支付金额：<span class="text-size26 cor-orange text-blod">￥{{ sprintf(" %1\$.2f",$task['bounty']) }}</span></p>
                    <div class="space"></div>
                    <p>请选择支付方式</p>
                </div>
                <div class="space"></div>
                <div class="tabbable">
                    ...
                    <div class="tab-content clearfix f-tab">
                        ...
                        <div class="tab-pane in active clearfix text-size14 cor-gray51 u-pay" id="home1">
                            @if($balance_pay)
                                <form class="form-horizontal" role="form" action="/task/bidBountyUpdate" method="post"  name="bounty-form">
                                    {{ csrf_field() }}
                                ...
                                <div class="text-size14 cor-gray51">
                                    ...
                                    您的余额不足，请选择其他支付方式或是去　<a href="/finance/cash" class="btn btn-sm btn-orange34 bor-radius2">充值</a>　<a href="/task/{{ $id }}" class="cor-gray93 btn-big1">返回</a>
                                    <br>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="tab-pane clearfix" id="home2">
                            <form class="form-horizontal" role="form" action="/task/bidBountyUpdate" method="post"  name="bounty-form" target="_blank">
                                {{ csrf_field() }}
                                <input type="hidden" name="id" value="{{ $id }}" />
