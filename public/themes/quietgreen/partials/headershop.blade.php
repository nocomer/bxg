                    ...
                    <div class="row">
                        <a href="{!! CommonClass::homePage() !!}">
                            @if(Theme::get('site_config')['site_logo_1'])
                                <img src="{!! url(Theme::get('site_config')['site_logo_1'])!!}" class="img-responsive wrap-side-img" onerror="onerrorImage('{{ Theme::asset()->url('images/mb1/logo1.png')}}',$(this))">
                            @else
                ...
                <nav class="navbar bg-blue navbar-default hov-nav" role="navigation">
                    ...
                    <div class="collapse navbar-collapse pull-right g-nav pd-left0 pos-rela" id="example-navbar-collapse">
                        ...
                        <ul class="nav navbar-nav overhide">
                            ...
                            @endif
                            <li class="pd-navppd">
                                <form class="navbar-form navbar-left hd-seachW" action="/shop/work/{!! Theme::get('SHOPID') !!}" role="search" method="get" class="switchSearch">
