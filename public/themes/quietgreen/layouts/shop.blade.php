...
<head>
    ...
    <link rel="stylesheet" href="/themes/quietgreen/assets/plugins/ace/css/dropzone.css">
    <link rel="stylesheet" href="/themes/quietgreen/assets/plugins/ace/css/chosen.css" />
    <link rel="stylesheet" href="/themes/quietgreen/assets/plugins/ace/css/datepicker.css"/>
    ...
    <link rel="stylesheet" href="/themes/quietgreen/assets/css/shop/shop.css"/>
    <link rel="stylesheet" href="/themes/quietgreen/assets/css/{!! Theme::get('color') !!}/style.css">
    <link rel="stylesheet" href="/themes/quietgreen/assets/css/{!! Theme::get('color') !!}/style2.css">
    <!--编辑器-->
...
{{--<header>--}}
    {!! Theme::partial('headershop') !!}
{{--</header>--}}
<nav>
    {!! Theme::partial('shopnav') !!}
</nav>
<section>
    <div class="container">
        <div class="row">
...
<script src="/themes/quietgreen/assets/js/shopnav.js"></script>
