...
<form class="form-horizontal" action="{{ URL('manage/employUpdate') }}" method="post" name="seo-form">
    {{ csrf_field() }}
    ...
    <div class="g-backrealdetails clearfix bor-border interface">
        ...
        <div class="form-group interface-bottom col-xs-12">
            ...
            <div class="col-sm-9">
                ...
                <a target="_blank" href="{{ URL('employ/workin',['id'=>$data['id']]) }}" class="btn btn-sm btn-info">查看前台详情</a>
            </div>
        </div>
