                    ...
                    <h3 class="header smaller lighter blue mg-bottom20 mg-top12">雇佣配置</h3>
                    ...
                    <div class="g-backrealdetails clearfix bor-border interface">
                        <form class="form-horizontal" action="/manage/configUpdate" method="post">
                            ...
                            {{--<div class="widget-header widget-header-flat">
                                <h5 class="widget-title">雇佣规则和雇佣资金设置</h5>
                            </div>--}}
                            <div class="space-8 col-xs-12"></div>
                             <div class="form-group interface-bottom col-xs-12">
                                <label class="col-sm-1  text-right">雇佣最小金额设定</label>
                                 <div class="col-sm-9 "><input type="text" name="{{ $config['employ_bounty_min_limit']['id'] }}" value="{{ $config['employ_bounty_min_limit']['rule'] }}" class="change_ids" > 元(设置雇佣最小金额不得小于0元)</div>
                            </div>
                             <div class="form-group interface-bottom col-xs-12">
                                <label class="col-sm-1  text-right">雇佣成功提成比例</label>
                             ...
                             <div class="form-group interface-bottom col-xs-12">
                                <label class="col-sm-1  text-right"> 维权时间限定配置</label>
                                 <div class="col-sm-9 "><input type="text"  name="{{ $config['employee_right_time']['id'] }}" value="{{ $config['employee_right_time']['rule'] }}" class="change_ids"> 小时(服务商交付以后，可以维权的等待时间X小时，设为0则无限制）</div>
                            </div>
                             <div class="form-group interface-bottom col-xs-12">
                                <label class="col-sm-1  text-right">取消雇佣时间配置</label>
