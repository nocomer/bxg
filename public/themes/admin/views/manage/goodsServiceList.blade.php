            ...
            <div class="well">
                <form class="form-inline" role="form" action="/manage/goodsServiceList" method="get">
                    ...
                    <div class="form-group search-list ">
                        ...
                        <input type="text" class="form-control" id="goods_name" name="goods_name" placeholder="请输入服务名" @if(isset($merge['goods_name']))value="{!! $merge['goods_name'] !!}" @endif>
                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" id="deal" data-id="{!! $item->id !!}">
                                    ...
                                    @endif
                                    <a class="btn btn-xs btn-warning" href="/manage/serviceInfo/{!! $item->id !!}">
