                ...
                <h3 class="header smaller lighter blue mg-bottom20 mg-top12">广告编辑</h3>

            <form class="form-horizontal" action="/advertisement/updateInfo/{!! $ad_id !!}" method="post" enctype="multipart/form-data" id="ad">
                {{ csrf_field() }}
                        ...
                        <div class="g-backrealdetails clearfix bor-border">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <input type="text" name="ad_name" value="{!! $adInfo[0]['ad_name'] !!}">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <select name="target_id" class="target_id">
                                            ...
                                            @foreach($adTargetInfo as $adTargetInfoV)
                                                <option value="{!! $adTargetInfoV->target_id !!}" data-values="{!! $adTargetInfoV->code !!}" @if($adTargetInfoV->target_id == $adInfo[0]['target_id'])selected="selected"@endif>{!! $adTargetInfoV->name !!}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-left col-md-10">
                                        <div class="input-group col-md-2 pull-left">
                                            <input id="date-timepicker1" name="start_time" value="{!! $adInfo[0]['start_time'] !!}" type="text" class="form-control">
                                ...
                                <tr>
                                    ...
                                    <td class="text-left col-md-10">
                                        <div class="input-group col-md-2 pull-left">
                                            <input id="date-timepicker2" name="end_time" value="{!! $adInfo[0]['end_time'] !!}" type="text" class="form-control">
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-clock-o bigger-110"></i>
                                                        </span>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <input type="text" name="ad_url" value="{!! $adInfo[0]['ad_url'] !!}"  class="col-sm-6">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <div class="ace-spinner touch-spinner" style="width: 100px;"><div class="input-group">
                                                ...
                                                <input type="text" id="spinner3" name="listorder" value="{!! $adInfo[0]['listorder'] !!}" class="input-mini spinner-input form-control"  maxlength="3">
