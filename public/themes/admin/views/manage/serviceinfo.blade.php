    <div class="widget-header mg-bottom20 mg-top12 widget-well">
        <div class="widget-toolbar no-border pull-left no-padding">
            ...
            <li class="">
                <a  href="/manage/serviceComments/{!! $goods_info->id !!}">评价</a>
            </li>
        </ul>
    </div>
</div>
...
<form class="form-horizontal"  action="/manage/saveServiceInfo" method="post" name="seo-form">
    ...
    <div class="g-backrealdetails clearfix bor-border interface">
        ...
        <div class="form-group interface-bottom col-xs-12">
            ...
            <div class="col-sm-8">
                @if($goods_info->status == 0)待审核
                @elseif($goods_info->status == 1)售卖中
                @elseif($goods_info->status == 2)下架
                @elseif($goods_info->status == 3)审核失败
                @endif
            </div>
        </div>
        <div class="form-group interface-bottom col-xs-12">
        ...
        <div class="col-xs-12">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-sm-10" id="delete_id" data-id="{!! $goods_info->id !!}">
        ...
        <div class="col-xs-12">
            ...
            <div class="col-sm-9">
                <div class="space"></div>
                <a href="/manage/serviceInfo/{!! $pre_id !!}">上一项</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="/manage/serviceList">返回列表</a>&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="/manage/serviceInfo/{!! $next_id !!}">下一项</a>
                <div class="space"></div>
            </div>
        </div>
    </div>
...
{!! Theme::asset()->container('custom-js')->usepath()->add('shoplist', 'js/doc/servicelist.js') !!}