...
<div class="col-xs-12 col-left">
    <div class="taskDetails alert taskbg clearfix employ-bounty">
        <div class="page-header">
            <h4 class="text-size22 cor-gray51">
                <strong>您的订单提交成功，请尽快支付！</strong>
                <div class="space-8"></div>
                <p class="text-size12 cor-gray51">请您在提交订单后24小时内完成支付，否则订单自动取消</p>
            </h4>
        </div>
        <div class="cor-gray51 text-size14">
            <div class="space"></div>
            <p>支付金额：<span class="text-size26 cor-orange text-blod">￥{!! $pay_cash !!}</span></p>
            <div class="space"></div>
            <p>请选择支付方式</p>
        </div>
        <div class="space"></div>
        <div class="tabbable">
            ...
            <div class="tab-content clearfix f-tab">
                ...
                <div class="tab-pane in active clearfix text-size14 cor-gray51 u-pay" id="home1">
                    @if($balance_pay)
                        <form class="form-horizontal" role="form" action="/shop/postPayOrder" method="post"  name="goods_form">
                            {{csrf_field()}}
                    ...
                    @else
                        ...
                        <div class="text-size14 cor-gray51">
                            ...
                            <a href="javascript:history.back()" class="btn btn-white bor-radius2">返回</a>
                            <br>
                        </div>
                    @endif
                </div>
                ...
                <div class="tab-pane clearfix" id="home2">
                    <form class="form-horizontal" role="form" action="/shop/postPayOrder" method="post"  name="bounty-form" target="_blank">
                        {{ csrf_field() }}
                        <input type="hidden" name="id" value="{{ $id }}" />
                        <input type="hidden" name="pay_canel" id="pay-canel" value=1 />
                        <div class="space"></div>
                        <div class="radio clearfix">
                            @if($pay_config['alipay']['status'])
                            ...
                            @endif
                            @if($pay_config['wechatpay']['status'])
                                <label class="clearfix inline check-boxItm">
                     ...
                     <div class="modal-body text-center clearfix">
                         ...
                         <div class="col-sm-8 hidden-xs">
                             <div class="cor-gray51 text-left">
                                 ...
                                 <p><a href="javascript:history.back()" class="cor-blue167 text-under">返回选择其他支付方式></a></p>
                             </div>
                         </div>
                         ...
                         <div class="hidden-lg hidden-md hidden-sm visible-xs-12">
                             <div class="cor-gray51 text-center">
                                 ...
                                 <p><a href="javascript:history.back()" class="cor-blue167" data-dismiss="modal">返回选择其他支付方式></a></p>
                             </div>
                         </div>
                     </div>
                 </div>
