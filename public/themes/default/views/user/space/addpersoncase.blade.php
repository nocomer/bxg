        ...
        <div class="row">
            <div class="col-xs-12 col-left">
                <div class="add-case add-case992">
                        <form class="form-horizontal demoform" action="/user/addCase" method="post" enctype="multipart/form-data" id="success-case">
                        {{ csrf_field() }}
                        <div class="form-group">
                            <label class="col-sm-1 col-xs-4 control-label no-padding-right" for="form-field-1"><strong>案例名称：</strong>  </label>
                            <div class="col-sm-11 col-xs-8 task-casehid">
                                <input type="text" id="form-field-1" name='title' class="col-xs-6 col-sm-3" placeholder="请填写案例名称" datatype="*" nullmsg="请填写案例名称！" ><span class="Validform_checktip vilid-wrprg"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4 col-xs-8">
                                <div class="memberdiv pull-left">
                                    <div class="position-relative case-heg48">
                        ...
                        <div class="form-group task-r case-marbot" style="padding: 0;border:0;">
                            <label class="col-sm-1 col-xs-12  control-label no-padding-right" for="form-field-1"><strong>案例分类：</strong>  </label>
                            <div class="col-sm-11 col-xs-12 task-casewra task-casehid">
                                ...
                                <div class="task-select1 collapse col-xs-3 col-sm-3 task-casemr10" id="gd" >
                                    <div class="row">
                                ...
                                <div class="task-Validform-filtersort task-casepdt10">
                                    <input type="hidden" name="cate_id" id="task_category"  datatype="n" nullmsg="请选择需要做什么！" />
                                </div>
                            </div>
                        </div>
                        <!-- 案例描述 -->
                        <div class="form-group case-marbot task-casehid task-casepdt24">
                            <label class="col-sm-1 col-xs-12 control-label no-padding-right" for="form-field-1"><strong>案例描述：</strong>  </label>
                            <div class="col-sm-11 col-xs-12">
                                <!--编辑器-->
                                <script id="editor"  type="text/plain" style="height:300px;">{!! old('description') !!}</script>
                                <input type="hidden" name="description" id="discription-edit" datatype="*1-5000" nullmsg="案例描述不能为空" errormsg="字数超过限制" >
                            </div>
                        </div>
                        <div class="form-group case-marbot">
                            ...
                            <div class="col-sm-11 col-xs-8">
                                <input type="text" id="form-field-1" name="url" class="col-xs-6 col-sm-3" placeholder="请填写案例链接"><span class="pdlihei">(选填)</span>
                            </div>
                        </div>
                    ...
                    <div class="form-group clearfix">
                        <div class="col-sm-11 col-xs-11 col-sm-offset-1 col-xs-offset-1">
                            ...
                            @if($id == 1)
                            <a href="{!! URL('user/personCase') !!}" title="" class="text-under add-case-concel">返回</a>
                            @elseif($id == 2)
                                <a href="{!! URL('user/personevaluation') !!}" title="" class="text-under add-case-concel">返回</a>
                             @endif
                        </div>
                    </div>
                        </form>
