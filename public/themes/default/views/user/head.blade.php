                                ...
                                <div class="col-sm-5 fileleft">
                                    <div class="filebg">
                                        <div style="height:192px;margin-bottom: 8px;margin-left: -4px;">
                                            <img class="filebgimg cropper" src="{!! asset("attachment/avatar/large/".$id.'.jpg') !!}" id="headimg" alt="Picture" />
                                        </div>
                                        <div>
...
{!! Theme::asset()->container('footer2')->usepath()->add('cropper','css/cropper.css') !!}
{!! Theme::asset()->container('footer2')->usepath()->add('docs','css/docs.css') !!}
...
{!! Theme::asset()->container('footer2')->usepath()->add('userimg','css/newindex/usercenter/userimg.css') !!}
{!! Theme::asset()->container('footer')->usepath()->add('uploadify', 'js/jquery.uploadify.min.js') !!}
{!! Theme::asset()->container('footer')->usepath()->add('cropper', 'js/cropper.js') !!}
{!! Theme::asset()->container('footer')->usepath()->add('docs', 'js/docs.js') !!}
