<div class="g-main g-releasetask">
    <h4 class="text-size16 cor-blue2f u-title">我购买的服务</h4>
    <div class="space-12"></div>
    <div class="clearfix g-reletaskhd hidden-xs">
        <form action="/user/serviceMine" method="get">
            <div class="pull-left">
                <div class="pull-left">
            ...
            <div class="col-sm-11 col-xs-10 usernopd">
                <div class="col-sm-9 col-xs-8">
                    <div class="text-size14 cor-gray51">
                        <span class="cor-orange">￥{{ $v['bounty'] }}</span>&nbsp;&nbsp;
                        <a class="cor-blue42" href="{{ URL('employ/workin',['id'=>$v['id']]) }}" target="_blank">{{ $v['title'] }}</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;{{ $map[$v['status']] }}
                    </div>
                    <div class="space-6"></div>
