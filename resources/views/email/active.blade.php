                ...
                <div style="width:650px;text-align:left;font:12px/15px simsun;color:#000;background:#fff;">
                    <div style="background: url('{!! url('themes/default/assets/images/sign-emailbg.png') !!}') no-repeat;min-height: 474px;padding: 43px;">
                        ...
                        <div style="font-size: 14px;color: #515151;">
                            ...
                            <a onmouseover="this.style.background='#a3a2a0';" onmouseout="this.style.background='#2f55a0';" onclick="this.style.background='#a3a2a0';" href="{!! url('activeEmail/'. $data['validationInfo']) !!}" style="display:block;width:177px;height: 45px;background: #2f55a0;color: #fff;text-align: center;line-height: 45px;border-radius: 2px;text-decoration: none">验证邮箱</a>

                            <p>也可以复制以下链接：</p>

                            <p>{!! url('activeEmail/'. $data['validationInfo']) !!}</p>
